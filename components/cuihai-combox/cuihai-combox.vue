	...
	<view class="uni-combox">
		...
		<view class="uni-combox__input-box">
			<input class="uni-combox__input" type="text" :placeholder="placeholder" :disabled="isDisabled" v-model="inputVal"
			 @input="_onInput" @focus="_onFocus" @blur="onBlur" />
			<icon type="clear" size="14" @tap="clearInputValue" v-if="!isDisabled"  />
			<image class="uni-combox__input-arrow" src="/static/image/arrow_down.png" style="width: 30rpx;height: 30rpx;" @click="toggleSelector"></image>
